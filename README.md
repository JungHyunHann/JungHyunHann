...
<img src="https://capsule-render.vercel.app/api?type=waving&color=C9897A&height=200&section=header&text=Han%20Jung%20Hyun&fontSize=50&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI%20기술과%20사용자%20경험을%20잇는%20개발자&descAlignY=55&descAlign=50" />
...
| 2025.03 ~ 2026.02 | UMC 8기 & 9기 iOS |
| 2025.05 ~ 2025.12 | 학부연구생 — AI 미디어아트 파이프라인 (논문 게재) |
...
| 프로젝트 | 설명 | 기술 | 링크 |
|---|---|---|---|
| 🦁 여기톤 - Deverlow | 멋쟁이사자처럼 해커톤 · 성장 관리 시스템 | HTML, CSS, JS | [GitHub](https://github.com/2024-HERETHON/2024-Herethon-18) |
...
| 📅 TAMINGO (UMC 9기) | 일정 직후 근처 to-do를 원탭으로 끝내는 시간·동선 보조앱 | SwiftUI | [GitHub](https://github.com/TAMINGO-UMC/TAMINGO-iOS) |
| 🎲 TRPG | TRPG 웹 게임 | HTML, CSS, JS | [GitHub](https://github.com/JungHyunHann/TRPG) |
| 🏠 V-O Project | iOS LiDAR 공간 스캔 · FastAPI 서버 · 3DGS 연구 | Swift, FastAPI, Python | [GitHub](https://github.com/orgs/VirtualOptimization/repositories) |
| 🤟 Sign-to-Type (FingerType) | YOLOv8 · ByteTrack 기반 실시간 수어 알파벳 인식 시스템 | Python, YOLOv8 | [GitHub](https://github.com/e0ng/FingerType) |
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=C9897A&height=100&section=footer" />
